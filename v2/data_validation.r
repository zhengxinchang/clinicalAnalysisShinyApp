...
requestAndCleanDataframePatient<- function(){
  # patientdf <- jsonlite::fromJSON("https://ngdc.cncb.ac.cn/aml/dataAnalysis/patientData")
  patientdf <- jsonlite::fromJSON("./data/patientData.json")
...
requestAndCleanDataframeInitial<- function(){
  ...
  # initialdf <- jsonlite::fromJSON("https://ngdc.cncb.ac.cn/aml/dataAnalysis/initialData")
  initialdf <- jsonlite::fromJSON("./data/initialData.json")
...
getJsonPeroid<-function(){
  ...
  # Peroiddf <- jsonlite::fromJSON("https://ngdc.cncb.ac.cn/aml/dataAnalysis/periodData")
  Peroiddf <- jsonlite::fromJSON("./data/periodData.json")
...
requestAndCleanDataframeArchive <- function(){
  ...
  # archiveJson <- jsonlite::fromJSON("https://ngdc.cncb.ac.cn/aml/dataAnalysis/archiveData")
  archiveJson <- jsonlite::fromJSON("./data/archiveData.json")
